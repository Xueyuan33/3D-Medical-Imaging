...
//
void ITK_ABI_IMPORT HDF5TransformIOFactoryRegister__Private();void ITK_ABI_IMPORT MatlabTransformIOFactoryRegister__Private();void ITK_ABI_IMPORT TxtTransformIOFactoryRegister__Private();
